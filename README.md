...
> Este repositório documenta uma jornada real de aprendizado em IA — com teoria, prática, experimentação e evolução contínua.

**Descrição curta para About (≤ 160 caracteres):** Jornada de estudos em IA com 14 semanas: fundamentos, matemática, ML, DL, NLP, ética, IDEs com IA e arquitetura de contexto.

Este projeto organiza os estudos da pós-graduação em Inteligência Artificial em semanas temáticas, com atividades práticas e teóricas.  
A proposta é simples: estudar com profundidade, implementar com consistência e registrar aprendizados de forma organizada.
...
4. [Semana 4: Matemática e Estatística para IA - Probabilidade e Estatística](#semana-4-matemática-e-estatística-para-ia---probabilidade-e-estatística)
...
13. [Semana 13: Estudos IDE com IA](#semana-13-estudos-ide-com-ia)
14. [Semana 14: Engenharia de Arquitetura de Contexto](#semana-14-engenharia-de-arquitetura-de-contexto)

---

📅 **Início do plano:** `30/11/2024`  
🔄 **Status:** estudos em andamento, com atualização contínua dos materiais.
...
- **Tópicos:**
  ...
  - Abordagens em IA: raciocínio lógico, aprendizado de máquina e heurísticas
  - IA simbólica vs. IA conexionista
  - Ética e questões sociais em IA

- **Entrega:**
  - Leitura de artigos e livros sobre os fundamentos da IA
  - Relatório sobre história da IA e suas abordagens principais
  - Discussão sobre implicações sociais e éticas da IA
...
## Semana 4: Matemática e Estatística para IA - Probabilidade e Estatística
...
- **Tópicos:**
  ...
  - Testes estatísticos e modelagem probabilística
...
- **Material prático:** `exercicio_semana_4.ipynb`
...
- **Material prático:** `exercicio_semana_5.ipynb`
...
- **Material prático:** `exercicio_semana_6.ipynb`
...
- **Tópicos:**
  ...
  - Métodos ensemble (bagging e boosting)

- **Entrega:**
  - Implementação de algoritmos de aprendizado supervisionado
  - Comparação de desempenho entre os métodos

- **Pasta:** `semana_7_aprendizado_supervisionado`
- **Material prático:** `exercicio_semana_7.ipynb`
...
- **Material prático:** `exercicio_semana_8.ipynb`
...
- **Tópicos:**
  - Tokenização, lematização, stemização
...
- **Entrega:**
  ...
  - Aplicação de análise de sentimentos em dataset de texto
...
- **Entrega:**
  - Relatório sobre ética na IA com desafios e propostas de solução
...
## Semana 13: Estudos IDE com IA

- **Cronograma:** 01/12/2025 (início) — em evolução

- **Tópicos:**
  - Comparação de IDEs e assistentes de código com IA (Cursor, GitHub Copilot, Codeium e outros)
  - Recursos de edição, chat e refatoração com múltiplos arquivos
  - Modelos de negócio, privacidade, segurança e limites de uso
  - Estudos e métricas de produtividade publicadas pelas ferramentas

- **Entrega:**
  - Relatório comparativo com pontos fortes, limitações e preços
  - Recomendações práticas de adoção por tipo de projeto/equipe

- **Pasta:** `semana_13-Estudos_IDE`
- **Material:** `ide_IA.md`

---

## Semana 14: Engenharia de Arquitetura de Contexto

- **Cronograma:** em andamento

- **Tópicos:**
  - Conceitos de arquitetura de contexto para projetos com IA
  - Organização de informação para melhorar a qualidade de prompts e fluxos
  - Estruturação de práticas para continuidade e escalabilidade de projetos

- **Entrega:**
  - Documento técnico com diretrizes de arquitetura de contexto
  - Base de referência para evolução de boas práticas no projeto

- **Pasta:** `semana_14_engenharia_de_arquitetura_de_contexto`
- **Material:** `arquitetura.md`

---

## Conclusão

Este repositório segue vivo e em crescimento.
Cada semana adiciona mais clareza, mais prática e mais maturidade técnica na jornada em Inteligência Artificial. 🚀
...
### 3) IA moderna e impacto (Semanas 10–14)
